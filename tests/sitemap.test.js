...
test(`There is no: ${NEW_GAME_LINK} in the: ${PROD_SITEMAP} list`, async ({
  ...
  await expect(page.locator("#folder0")).not.toContainText(NEW_GAME_LINK);
});

const SITEMAP_INDEX = "https://mobalytics.gg/sitemap_index.xml";

test(`${SITEMAP_INDEX} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${PRODUCT_SITEMAP} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${VALORANT} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${TFT} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
...
test(`${SET14} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
...
test(`${SET10} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
...
test(`${LOST_ARK} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${DESTINY_2} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
  await expect(page.locator("#folder0")).toContainText(LOST_ARK);
...
test(`${DIABLO_4} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${ELDEN_RING} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${MARVEL_RIVALS} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${MHV} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
...
test(`${DEADLOCK} is present in the: ${PROD_SITEMAP} list`, async ({
  page,
}) => {
  await page.goto(PROD_SITEMAP);
...
test(`${POE_2} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
...
test(`${BAZAAR} is present in the: ${PROD_SITEMAP} list`, async ({ page }) => {
  await page.goto(PROD_SITEMAP);
