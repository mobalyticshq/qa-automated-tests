...
test.describe('Verify ad blocks within the mobile viewport range (320–575px) for different user roles', async () => {
  ...
  filterProjectsByAdvertisement('advertisement').forEach(({ game, projectPath }) => {
    test(`Check video block & footer banner for unauthorized user - ${game} in mobile at 360x780 viewport size`, async ({
      ...
      // await page.setViewportSize({ width: 420, height: 800 }); // custom viewport range
  ...
  // filterProjectsByAdvertisement('advertisement').forEach(({ game, projectPath }) => {
  //   test(`Check ad blocks for regular user - ${game} in mobile at 360x780 viewport size`, async ({
  //     page,
  //   }) => {
  //     test.skip(game === 'Val', "Valorant doesn't contain ad on mobile devices");
  //     // await page.setViewportSize({ width: 1280, height: 800 }); // custom viewport range
...
test.describe('Verify ad blocks within the mobile viewport range (576-767px) for different user roles', async () => {
  filterProjectsByAdvertisement('advertisement').forEach(({ game, projectPath }) => {
    test(`Check advertisement blocks for unauthorized user - ${game} in mobile at 640x1024 viewport size`, async ({
      page,
    }) => {
      test.skip(game === 'Val', "Valorant doesn't contain ad on mobile devices");
      ...
      switch (game) {
        case 'LoL':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#lol-video-all-pages-mobile').or(page.locator('#lol-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
        ...
        case 'ZZZ':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#zzz-video-all-pages-mobile').or(page.locator('#zzz-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
        ...
        case 'TFT':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#tft-video-all-pages-mobile').or(page.locator('#tft-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-tft-display-footer-m').or(page.locator('#tft-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'PoE':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#poe-video-all-pages-mobile').or(page.locator('#poe-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-poe-display-footer-m').or(page.locator('#poe-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'PoE 2':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#poe-2-video-all-pages-mobile').or(page.locator('#poe-2-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-poe-2-display-footer-m').or(page.locator('#poe-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'The Bazaar':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page.locator('#the-bazaar-video-all-pages-mobile').or(page.locator('#the-bazaar-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-the-bazaar-display-footer-m').or(page.locator('#the-bazaar-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Monster Hunter Wilds':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#mhw-video-all-pages-mobile').or(page.locator('#mhw-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-mhw-display-footer-m').or(page.locator('#mhw-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Riftbound':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page.locator('#riftbound-video-all-pages-mobile').or(page.locator('#riftbound-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-riftbound-display-footer-m').or(page.locator('#riftbound-nitro-m')))
              .toBeAttached();
          });
          break;
        case '2XKO':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#xko-video-all-pages-mobile').or(page.locator('#\\32 xko-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-2xko-display-footer-m').or(page.locator('#\\32 xko-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Marvel Rivals':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page
                  .locator('#marvel-rivals-video-all-pages-mobile')
                  .or(page.locator('#marvel-rivals-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-marvel-rivals-display-footer-m').or(page.locator('#marvel-rivals-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Deadlock':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#deadlock-video-all-pages-mobile').or(page.locator('#deadlock-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-deadlock-display-footer-m').or(page.locator('#deadlock-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Diablo 4':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#diablo-4-video-all-pages-mobile').or(page.locator('#diablo-4-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-diablo-4-display-footer-m').or(page.locator('#diablo-4-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Destiny 2':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page.locator('#destiny-2-video-all-pages-mobile').or(page.locator('#destiny-2-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-destiny-2-display-footer-m').or(page.locator('#destiny-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Borderlands 4':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#bl4-video-all-pages-mobile').or(page.locator('#borderlands-4-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
        ...
        case 'Hades 2':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#hades-2-video-all-pages-mobile').or(page.locator('#hades-2-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-hades-2-display-footer-m').or(page.locator('#hades-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Endfield':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page
                  .locator('#endfield-video-all-pages-mobile')
                  .or(page.locator('#arknights-endfield-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
        ...
        case 'Marathon':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#marathon-video-all-pages-mobile').or(page.locator('#marathon-nitro-video').first()))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
        ...
        case 'Overwatch':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(
                page.locator('#overwatch-video-all-pages-mobile').or(page.locator('#overwatch-nitro-video').first())
              )
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
    ...
    test(`Check video block & footer banner for unauthorized user - ${game} in desktop at 800x800 viewport size`, async ({
      ...
      switch (game) {
        case 'LoL':
          await test.step(`Expected Result: Video banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#lol-video-all-pages').or(page.locator('#lol-nitro-video').locator('xpath=..')))
              .toBeAttached();
          });
          await test.step(`Expected Result: Big vertical banner isn't present on the page`, async () => {
            await expect
        ...
        case 'TFT':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-tft-display-footer-d').or(page.locator('#tft-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'PoE':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-poe-display-footer-d').or(page.locator('#poe-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'PoE 2':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-poe-2-display-footer-d').or(page.locator('#poe-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'The Bazaar':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-the-bazaar-display-footer-d').or(page.locator('#the-bazaar-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Monster Hunter Wilds':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-mhw-display-footer-d').or(page.locator('#mhw-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Nightreign':
        ...
        case 'Riftbound':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-riftbound-display-footer-d').or(page.locator('#riftbound-nitro-m')))
              .toBeAttached();
          });
          break;
        case '2XKO':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-2xko-display-footer-d').or(page.locator('#\\32 xko-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Marvel Rivals':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-marvel-rivals-display-footer-d').or(page.locator('#marvel-rivals-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Deadlock':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-deadlock-display-footer-d').or(page.locator('#deadlock-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Diablo 4':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-diablo-4-display-footer-d').or(page.locator('#diablo-4-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Destiny 2':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-destiny-2-display-footer-d').or(page.locator('#destiny-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Borderlands 4':
        ...
        case 'Hades 2':
          ...
          await test.step(`Expected Result: Footer banner is present on the page`, async () => {
            await expect
              .soft(page.locator('#web-hades-2-display-footer-d').or(page.locator('#hades-2-nitro-m')))
              .toBeAttached();
          });
          break;
        case 'Endfield':
...
test.describe('Verify ad blocks within the desktop viewport range (1024-1232px) for different user roles', async () => {
  filterProjectsByAdvertisement('advertisement').forEach(({ game, projectPath }) => {
    test(`Check video block & footer banner for unauthorized user - ${game} at 1100x800 viewport size`, async ({
      page,
    }) => {
