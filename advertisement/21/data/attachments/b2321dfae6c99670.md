...
- Name: advertisement.test.js >> Verify ad blocks within the mobile viewport range (320–575px) for different user roles >> Check ad blocks for regular user - PoE 2 in mobile at 360x780 viewport size
