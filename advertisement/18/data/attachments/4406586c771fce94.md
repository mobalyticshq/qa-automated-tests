...
- Name: advertisement.test.js >> Verify ad blocks within the desktop viewport range (1024-1232px) for different user roles >> Check video block & footer banner for ad free user - Monster Hunter Wilds in desktop at 1100x800 viewport size
...
- generic [active] [ref=e1]:
  ...
  - button "Do Not Sell or Share My Personal Information" [ref=e1063] [cursor=pointer]:
    - paragraph [ref=e1065]: Do Not Sell or Share My Personal Information
```
