...
- Location: /home/runner/work/qa-automated-tests/qa-automated-tests/tests/ngf.test.js:632:9
...
Call log:
  - waiting for getByText('Link')
    ...
    at /home/runner/work/qa-automated-tests/qa-automated-tests/tests/ngf.test.js:645:7
```
...
```ts
   ...
   95 |     await test.step(`Click Сancel button on the control panel`, async () => {
