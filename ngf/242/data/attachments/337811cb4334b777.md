...
- Name: ngf.test.js >> Game Manager permission >> View mode of the "/qa-not-delete-st-page" structure page is available for the Game Manager role
- Location: e2e-tests/ngf.test.js:826:3
...
Call log:
  - waiting for getByTestId('admin-page-st-document-item-card').filter({ hasText: '/qa-not-delete-st-page' })
