...
- generic [ref=e1]:
  ...
  - dialog [ref=e225]:
    - generic [ref=e229]:
      - generic [ref=e230]: Create and Save Page
      - button [ref=e232] [cursor=pointer]:
        - img [ref=e233]
    - generic [ref=e234]:
      - generic [ref=e236]:
        - generic [ref=e240]: Page Path
        - textbox [ref=e243]:
          - /placeholder: /path
          - text: /qa-automation-st-page-2a5bb3e6-a8a9-4637-91bd-b5bd4d655c15
      - generic [ref=e245]:
        - button [ref=e246] [cursor=pointer]: Cancel
        - button [ref=e247] [cursor=pointer]: Create and Save
  - dialog [active] [ref=e250]:
    - generic [ref=e254]:
      - generic [ref=e255]: Changes could not be saved
      - button [ref=e257] [cursor=pointer]:
        - img [ref=e258]
    - generic [ref=e260]:
      - generic [ref=e261]: There was an unexpected error while saving your changes. Please reload the page and try again. If this issue persists please contact support, or submit a bug report to notify our team.
      - generic [ref=e262]: Information for the Support Center
      - generic [ref=e263]: "BAD_REQUEST - request_id: 1d9bff95-ad15-4029-8e9e-5a6326a1bbff, widgets generating error: widget 1 err - got error from InitWidgetFunc: widget_id: validation error, 1, LinksGridManualV2Widget is invalid: items amount must be in [1, 5]"
    - generic [ref=e265]:
      - link "Contact Support" [ref=e266] [cursor=pointer]:
        - /url: https://support.mobalytics.gg/hc/en-us
        - generic [ref=e267]: Contact Support
      - button "Submit Bug" [ref=e268] [cursor=pointer]:
        - img [ref=e269]
        - text: Submit Bug
```