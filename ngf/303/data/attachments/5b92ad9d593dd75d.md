...
- Name: ngf.test.js >> Creating UG Pages >> Create a classic page on LoL project
- Location: e2e-tests/ngf.test.js:520:5
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e4]:
      ...
      - main [ref=e181]:
        - generic [ref=e183]:
          - heading "404" [level=1] [ref=e184]
          - heading "The page you are looking for is not found" [level=2] [ref=e185]
          - paragraph [ref=e186]: There may have been an error or the link you tried may be broken.
    - generic:
