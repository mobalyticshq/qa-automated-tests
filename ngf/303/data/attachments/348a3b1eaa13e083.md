...
- Name: ngf.test.js >> Creating UG Pages >> Create a guide page on Borderlands 4 project
...
Call log:
  - waiting for getByRole('button', { name: 'Create' })
    - locator resolved to <button tabindex="0" type="button" aria-haspopup="true" aria-expanded="false" data-react-aria-pressable="true" id="react-aria7290897162-_r_17_" class="xh8yej3 x1hv8zah x1h7s0lp x78zum5 x6s0dn4 xl56j7k x167g77z xlkovuz x1ypdohk x1deyofa x1kylzug x1vlpaxp x154mpj6 x10w6t97 xxepmn2">…</button>
...
- generic [active] [ref=e1]:
  ...
  - button "Do Not Sell or Share My Personal Information" [ref=e810] [cursor=pointer]:
    - paragraph [ref=e812]: Do Not Sell or Share My Personal Information
```
