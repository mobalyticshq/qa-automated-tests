...
Call log:
  - waiting for getByTestId('add-widget-button')
    - locator resolved to <button tabindex="0" type="button" aria-haspopup="true" aria-expanded="false" id="react-aria6934413085-_r_h_" data-testid="add-widget-button" data-react-aria-pressable="true" class="x1hv8zah x1h7s0lp x78zum5 x6s0dn4 xl56j7k x167g77z xlkovuz x1ypdohk xjbqb8w x1f3rem x1717udv x1td3qas x10w6t97">…</button>
    ...
    - generic [ref=e3]:
      - link "Update available! Our new and improved standalone app is more stable, has better performance and quicker updates. Please install now → Update App Close":
        ...
        - generic [ref=e4] [cursor=pointer]:
          - generic [ref=e5]:
            - paragraph [ref=e11]: Update available! Our new and improved standalone app is more stable, has better performance and quicker updates. Please install now
            - button "→ Update App" [ref=e12]
          - img "Close" [ref=e13]
      - generic [ref=e14]:
        - generic [ref=e15]:
        ...
        - generic [ref=e114]:
          ...
          - generic [ref=e135]:
            - link "A admin+stg+ns@mobalyticshq.com" [ref=e136] [cursor=pointer]:
              - /url: /2xko/profile/asd-das-8to5p0
              - generic [ref=e138]:
                - generic [ref=e140]: A
        ...
        - generic [ref=e152]:
          - link "Home" [ref=e155] [cursor=pointer]:
            - /url: /2xko
            - img "Home" [ref=e157]
          - link "Champions" [ref=e160] [cursor=pointer]:
            - /url: /2xko/champions
            - img "Champions" [ref=e162]
        ...
        - main [ref=e175]:
          - generic [ref=e176]:
            - generic [ref=e178]:
              - generic [ref=e180]: New Page
              - generic [ref=e181]:
                - button "Create and Save" [ref=e182] [cursor=pointer]
            ...
            - generic [ref=e186]:
              - button [ref=e190]:
                - button [ref=e197] [cursor=pointer]:
                  - img [ref=e199]
              - button "Add section" [active] [ref=e201] [cursor=pointer]:
                - img [ref=e202]
                - text: Add section
              - status [ref=e203]
      - generic [ref=e204]:
        ...
        - generic [ref=e208]:
          ...
          - generic [ref=e213]:
            - generic [ref=e214]:
              - 'link "Unlock 6 Rewards +1 Ends in: 2 days Activate" [ref=e215] [cursor=pointer]':
                ...
                - generic [ref=e216]:
                  - generic [ref=e217]:
                    ...
                    - generic [ref=e219]:
                      - banner [ref=e220]:
                        - generic [ref=e222]: title test
                      - generic [ref=e223]:
                        - paragraph [ref=e224]: Unlock 6 Rewards
                        - generic [ref=e236]: "+1"
                  - contentinfo [ref=e237]:
                    - generic "July 30, 2026 07:00 PM GMT+00:00" [ref=e238]:
                      - img [ref=e239]
                      - generic [ref=e240]: "Ends in: 2 days"
                    - button "Activate" [ref=e241]
              - link "Explore Reward Passes" [ref=e242] [cursor=pointer]:
                - /url: /reward-pass
                - generic [ref=e243]: Explore Reward Passes
            - separator [ref=e244]
            - generic [ref=e245]:
              - heading "Challenges" [level=4] [ref=e246]
              - generic [ref=e247]:
                - generic [ref=e248]: No challenges at the moment
                - generic [ref=e249]: We are working on something special
    - generic:
      - region "Notifications Alt+T"
  - button "Do Not Sell or Share My Personal Information" [ref=e253] [cursor=pointer]:
    - paragraph [ref=e255]: Do Not Sell or Share My Personal Information
```
