...
- Name: Checking role permissions >> Game Manager permission >> View mode of the "/qa-not-delete-st-page" structure page is available for the Game Manager role
- Location: /home/runner/work/qa-automated-tests/qa-automated-tests/e2e-tests/tests/ngf.test.js:880:9
...
Expected string: "/qa-not-delete-st-page"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for getByTestId('document-controls-panel')

    at /home/runner/work/qa-automated-tests/qa-automated-tests/e2e-tests/tests/ngf.test.js:893:47
    at /home/runner/work/qa-automated-tests/qa-automated-tests/e2e-tests/tests/ngf.test.js:892:18
```
...
```ts
  ...
  794 |       baseURL,
  795 |     }) => {
  796 |       await page.context().addCookies(apiAuthInternalWriter.cookies);
  797 |       const moba = new Moba(page);
  798 |
  799 |       await moba.homePage.openMhwHomePage(baseURL);
  800 |       await test.step(`Expected Result: Control panel is missing for Internal Writer role`, async () => {
  801 |         await expect(moba.homePage.controlPanel).not.toBeVisible();
  802 |       });
  803 |     });
  804 |
  805 |     test("Check API Internal Writer permission", async ({
  806 |       request,
  807 |       apiAuthInternalWriter,
  808 |       baseURL,
  809 |     }) => {
