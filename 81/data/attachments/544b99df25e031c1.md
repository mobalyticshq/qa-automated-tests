...
Expected string: "ZZZ Guide"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('section').first()

    at /home/runner/work/qa-automated-tests/qa-automated-tests/e2e-tests/tests/ngf.test.js:493:45
    at /home/runner/work/qa-automated-tests/qa-automated-tests/e2e-tests/tests/ngf.test.js:492:16
```
...
- main:
  - navigation:
    - list:
      ...
      - listitem:
        - link "Profile":
          - /url: /zzz/profile?docType=guides
      - listitem: qa-automation-guide-page-1479247c-886c-49e5-b4c0-5936c60df3b5
  - text: qa-automation-guide-page-1479247c-886c-49e5-b4c0-5936c60df3b5 Draft
  - button "Publish"
  - button "Edit"
  - button "SEO":
    - img
  ...
  - button:
    - img
  - button "ZZZ Guide qa-automation-guide-page-1479247c-886c-49e5-b4c0-5936c60df3b5 Beginner By admin+stg+ns@mobalyticshq.com Updated on Jun 24, 2025":
    - text: ZZZ Guide
    - heading "qa-automation-guide-page-1479247c-886c-49e5-b4c0-5936c60df3b5" [level=1]
    - text: Beginner By
...
> 493 |       await expect(moba.ugBuildPage.header).toContainText("ZZZ Guide");
  ...
  536 |     });
  537 |
  538 |     test('St Widget contains "Edit" button, "Delete" button & "Create Page" button is present on ST Admin page for Admin role', async ({
  539 |       page,
  540 |       apiAuthAdmin,
  541 |       baseURL,
  542 |     }) => {
