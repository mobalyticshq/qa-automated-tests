const sitemapList = [
  ...
  { linkInList: `${process.env.BASE_URL}/riftbound`, isPresentInSitemap: true, pathUrl: '/riftbound/sitemap.xml' },
...
const projectListFromSitemap = [
  ...
  { project: 'Riftbound', isPresentInSitemap: true, pathUrl: '/riftbound/sitemap.xml' },
