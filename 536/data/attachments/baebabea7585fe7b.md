...
- generic [ref=e1]:
  ...
  - button [ref=e228] [cursor=pointer]:
    - paragraph [ref=e230]: Do Not Sell or Share My Personal Information
  - dialog [ref=e233]:
    - generic [ref=e237]:
      - generic [ref=e238]: Create and Save Page
      - button [ref=e240] [cursor=pointer]:
        - img [ref=e241]
    - generic [ref=e242]:
      - generic [ref=e244]:
        - generic [ref=e248]: Page Path
        - textbox [ref=e251]:
          - /placeholder: /path
          - text: /qa-automation-st-page-81b7b755-1eb8-4fc7-bdd5-91e36505d9c4
      - generic [ref=e253]:
        - button [ref=e254] [cursor=pointer]: Cancel
        - button [ref=e255] [cursor=pointer]: Create and Save
  - dialog [active] [ref=e258]:
    - generic [ref=e262]:
      - generic [ref=e263]: Changes could not be saved
      - button [ref=e265] [cursor=pointer]:
        - img [ref=e266]
    - generic [ref=e268]:
      - generic [ref=e269]: There was an unexpected error while saving your changes. Please reload the page and try again. If this issue persists please contact support, or submit a bug report to notify our team.
      - generic [ref=e270]: Information for the Support Center
      - generic [ref=e271]: "BAD_REQUEST - request_id: 98cb58d2-2c61-4d8e-9a66-41f66f43b137, widgets generating error: widget 1 err - got error from InitWidgetFunc: widget_id: validation error, 1, LinksGridManualV2Widget is invalid: items amount must be in [1, 5]"
    - generic [ref=e273]:
      - link "Contact Support" [ref=e274] [cursor=pointer]:
        - /url: https://support.mobalytics.gg/hc/en-us
        - generic [ref=e275]: Contact Support
      - button "Submit Bug" [ref=e276] [cursor=pointer]:
        - img [ref=e277]
        - text: Submit Bug
```